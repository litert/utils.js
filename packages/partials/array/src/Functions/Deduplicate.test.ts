...
NodeTest.describe('Module Array - Function Deduplicate', () => {

    // ─── Black-Box: Main Flow ────────────────────────────

    NodeTest.it('B-M-00001: Should deduplicate an array of numbers', () => {
    ...
    NodeTest.it('B-M-00002: Should deduplicate an array of strings', () => {
    ...
    NodeTest.it('B-M-00003: Should deduplicate an array of mixed basic types', () => {
    ...
    NodeTest.it('B-M-00004: Should return all elements when there are no duplicates', () => {

        const input = [1, 2, 3, 4, 5];
        const result = deduplicate(input);

        NodeAssert.deepStrictEqual(result, [1, 2, 3, 4, 5]);
    });

    NodeTest.it('B-M-00005: Should deduplicate objects by reference by default', () => {
    ...
    NodeTest.it('B-M-00006: Should not deduplicate distinct objects with same content by default', () => {
    ...
    NodeTest.it('B-M-00007: Should deduplicate objects using a key generation function', () => {
    ...
    NodeTest.it('B-M-00008: Should deduplicate objects using a composite key', () => {
    ...
    NodeTest.it('B-E-00001: Should handle an empty array', () => {
    ...
    NodeTest.it('B-E-00002: Should handle an array with a single element', () => {
    ...
    NodeTest.it('B-E-00003: Should handle an array where all elements are duplicates', () => {
    ...
    NodeTest.it('B-E-00004: Should deduplicate NaN values using Set semantics', () => {

        const result = deduplicate([NaN, 1, NaN, 2]);

        NodeAssert.strictEqual(result.length, 3);
        NodeAssert.ok(Number.isNaN(result[0]));
        NodeAssert.strictEqual(result[1], 1);
        NodeAssert.strictEqual(result[2], 2);
    });

    NodeTest.it('B-E-00005: Should handle makeKey returning undefined', () => {
    ...
    NodeTest.it('B-E-00006: Should handle makeKey returning objects (Map supports object keys)', () => {
    ...
    NodeTest.it('B-E-00007: Should handle makeKey returning distinct objects', () => {
    ...
    NodeTest.it('B-E-00008: Should handle makeKey returning objects with correct reference reuse', () => {
         const keyA = { k: 'a' };
         const keyB = { k: 'b' };
